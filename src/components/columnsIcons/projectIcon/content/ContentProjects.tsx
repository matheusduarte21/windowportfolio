    ...
    return(
        <div>
            ...
            <h3>Esteira CI/CD</h3>
             ...
             <img width='100%' height='300px' src={imgEsteira}/>
            ...
            <p>
               ...
               <div className="container-links-contents">
                  <p>link para o repositório: <a  target='_blank' href="https://github.com/matheusduarte21/testeCi">Repositório CI/CD</a></p>
               </div>
            ...
            <h3>TopMovies</h3>
             ...
             <img width='100%' height='300px' src={imgTopMovies}/>
            ...
            <p>
                ...
                <div className="container-links-contents">
                    <p>
                        link para repositório: <a  target='_blank' href="https://github.com/matheusduarte21/topMovies-react">Repositório TopMovies </a>
                    </p>
                    <p>
                        Deploy: <a  target='_blank' href="https://react-tmdb.netlify.app/">Clique para ver o Site</a> 
                    </p>
                </div>
            ...
            <h3>Projeto Freelancer</h3>
             ...
             <img width='100%' height='300px' src={imgFreelancer}/>
            ...
            Para a realização deste projeto, optei pelo uso do framework Angular, integrado ao BootStrap, CSS e TypeScript. Essa combinação de tecnologias foi escolhida cuidadosamente para desenvolver um front-end que não apenas atendesse às necessidades específicas do meu cliente, mas que também proporcionasse uma experiência de usuário fluida e agradável.
                 ...
                 <div className='container-links-contents'>
                 <p>
                        link para repositório: <a  target='_blank' href="https://github.com/matheusduarte21/freelancer">Repositório Freelancer </a>
                  </p>
                  <p>
                        Deploy: <a  target='_blank' href="https://guedesink.vercel.app/">Clique para ver o Site</a> 
                  </p>
                 </div>
            ...
            <h3>Projeto Angular/Java</h3>
             ...
             <img width='100%' height='300px' src={imgCrudAngularfrom}/>
            ...
            <p>
                ...
                No frontend, explorei o Angular, TypeScript, CSS e BOOTSTRAP para criar uma interface amigável. Fiz requisições HTTP utilizando os métodos GET, PUT, POST e DELETE para interagir com o backend, permitindo a manipulação de dados.
                 ...
                 <div className='container-links-contents'>
                    <p>
                        link para repositório: <a  target='_blank' href="https://github.com/matheusduarte21/Angular-Java-Project">Repositório Crud/Angular </a>
                    </p>
                 </div>
